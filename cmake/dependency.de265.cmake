...
ExternalProject_Add(DE265
    PREFIX ${CMAKE_CURRENT_BINARY_DIR}/libde265
    ...
    DOWNLOAD_DIR "${CMAKE_CURRENT_SOURCE_DIR}/dependencies/libde265"
    SOURCE_DIR "${EXTERNALPROJECT_SOURCE_PREFIX}/dependencies/libde265/source"
    BINARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/libde265/build"
    ...
    CMAKE_ARGS ${CMAKE_BUILD_TYPE_ARG} "-DBUILD_SHARED_LIBS=OFF" "-DENABLE_DECODER=ON" "-DENABLE_ENCODER=OFF" "-DENABLE_SDL=OFF"
        ...
        "-DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_CURRENT_BINARY_DIR}/libde265/install" ${CMAKE_DEBUG_POSTFIX_MULTICONF}
    EXCLUDE_FROM_ALL
)
...
set(LIBDE265_INCLUDE_DIRS ${CMAKE_CURRENT_BINARY_DIR}/libde265/install/include)
set(LIBDE265_LINK_DIRS ${CMAKE_CURRENT_BINARY_DIR}/libde265/install/lib)
if (WIN32)
