...
ExternalProject_Add(KVAZAAR
    ...
    CMAKE_ARGS ${CMAKE_BUILD_TYPE_ARG} "-DBUILD_SHARED_LIBS=OFF" "-DBUILD_TESTS=OFF" "-DUSE_CRYPTO=OFF"
        ...
        "-DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_CURRENT_BINARY_DIR}/kvazaar/install" ${CMAKE_DEBUG_POSTFIX_MULTICONF}
    EXCLUDE_FROM_ALL
)
...
set(KVAZAAR_INCLUDE_DIRS ${CMAKE_CURRENT_BINARY_DIR}/kvazaar/install/include)
set(KVAZAAR_LINK_DIRS ${CMAKE_CURRENT_BINARY_DIR}/kvazaar/install/lib)
if(WIN32)
