...
ExternalProject_Add(SVTAV1
    ...
    DOWNLOAD_DIR "${CMAKE_CURRENT_SOURCE_DIR}/dependencies/svtav1"
    SOURCE_DIR "${EXTERNALPROJECT_SOURCE_PREFIX}/dependencies/svtav1/source"
    BINARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/svtav1/build"
    ...
    CMAKE_ARGS ${CMAKE_BUILD_TYPE_ARG} "-DBUILD_SHARED_LIBS=OFF" "-DBUILD_APPS=OFF" "-DBUILD_TESTING=OFF" "-DSVT_AV1_LTO=ON" "-DUSE_CPUINFO=OFF" #"-DMINIMAL_BUILD=ON"
        ...
        "-DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_CURRENT_BINARY_DIR}/svtav1/install" ${CMAKE_DEBUG_POSTFIX_MULTICONF}
    EXCLUDE_FROM_ALL
)
...
set(SVTAV1_INCLUDE_DIRS ${CMAKE_CURRENT_BINARY_DIR}/svtav1/install/include)
set(SVTAV1_LINK_DIRS ${CMAKE_CURRENT_BINARY_DIR}/svtav1/install/lib)
