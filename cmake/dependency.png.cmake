...
ExternalProject_Add(PNG
    ...
    DOWNLOAD_DIR "${CMAKE_CURRENT_SOURCE_DIR}/dependencies/png"
    SOURCE_DIR "${EXTERNALPROJECT_SOURCE_PREFIX}/dependencies/png/source"
    BINARY_DIR "${CMAKE_CURRENT_BINARY_DIR}/png/build"
    INSTALL_DIR "${CMAKE_CURRENT_BINARY_DIR}/png/install"
    ...
    CMAKE_ARGS ${CMAKE_BUILD_TYPE_ARG} "-DZLIB_ROOT:PATH=${ZLIB_ROOT}" "-DPNG_SHARED=OFF" "-DPNG_STATIC=ON" "-DPNG_TESTS=OFF" "-DPNG_TOOLS=OFF" "-DPNG_FRAMEWORK=OFF" "-DPNG_DEBUG=OFF" 
        ...
        "-DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_CURRENT_BINARY_DIR}/png/install" "-DSKIP_INSTALL_EXECUTABLES=ON" "-DSKIP_INSTALL_PROGRAMS=ON"
    EXCLUDE_FROM_ALL
    DEPENDS ZLIB
)
