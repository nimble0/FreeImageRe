...
ExternalProject_Add(ZLIB
    ...
    DOWNLOAD_DIR "${CMAKE_CURRENT_SOURCE_DIR}/dependencies/zlib"
    ...
    INSTALL_COMMAND ${BUILD_COMMAND_FOR_TARGET} -t install
            COMMAND ${CMAKE_COMMAND} -E copy "${EXTERNALPROJECT_SOURCE_PREFIX}/dependencies/zlib/source/zutil.h" -t "${CMAKE_CURRENT_BINARY_DIR}/zlib/install/include"
    CMAKE_ARGS ${CMAKE_BUILD_TYPE_RELEASE} "-DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_CURRENT_BINARY_DIR}/zlib/install" "-DZLIB_BUILD_EXAMPLES=OFF"
